...
declare -A E10=( ["NAME"]=experiment10-choosingMetrics  ["BATCH_SIZE"]=100 ["RATS"]=20 ["SAMPLE_RATE"]=1  )
# E9[MIN_RAT]=8
# E10[MAX_RAT]=29
#E9[MIN_CONFIG]=0
# E9[MAX_CONFIG]=0
declare -A E11=( ["NAME"]=experiment11-article2  ["BATCH_SIZE"]=100 ["RATS"]=100 ["SAMPLE_RATE"]=5  )
