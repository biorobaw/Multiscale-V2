...
BATCH_SCRIPT="module add apps/python/3.7.3; python $SCRIPT_PLOT_PATHS ENAME/ c\$SLURM_ARRAY_TASK_ID"
...
[ -z "$DO_EXPERIMENT_1" ] || sbatch -a 0-279  $SCRIPT_PROCESS_CONFIG $LOG_FOLDER_E1/ 5
[ -z "$DO_EXPERIMENT_2" ] || sbatch -a 0-27   $SCRIPT_PROCESS_CONFIG $LOG_FOLDER_E2/ 5
[ -z "$DO_EXPERIMENT_3" ] || sbatch -a 0-27   $SCRIPT_PROCESS_CONFIG $LOG_FOLDER_E3/
[ -z "$DO_EXPERIMENT_4" ] || sbatch -a 0-219  $SCRIPT_PROCESS_CONFIG $LOG_FOLDER_E4/ 5
[ -z "$DO_EXPERIMENT_5" ] || sbatch -a 0-159  $SCRIPT_PROCESS_CONFIG $LOG_FOLDER_E5/ 10
[ -z "$DO_EXPERIMENT_6" ] || sbatch -a 0-109  $SCRIPT_PROCESS_CONFIG $LOG_FOLDER_E6/ 5
[ -z "$DO_EXPERIMENT_7" ] || sbatch -a 0-99   $SCRIPT_PROCESS_CONFIG $LOG_FOLDER_E7/ 5
