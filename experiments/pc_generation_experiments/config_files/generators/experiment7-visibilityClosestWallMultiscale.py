...
outputFileNoRats = '../norats7.csv'
outputFile     = '../experiment7-visibilityClosestWallMultiscale.csv'     # relative to this folder
...
pc_generation_raddi_thresholds_DF   = pd.DataFrame(columns = ['key', 'pc_generation_radii', 'pc_generation_threshold', 'mix_name' ], # assume bests are 0.004, 0.3, 0.4, 0.6
    data = [
        ...
        [0,     '0.08,0.24,0.4,0.56',    '0.008,0.2,0.3,0.3', 'mix3'],
        [0,     '0.08,0.24,0.4,0.56',    '0.008,0.2,0.3,0.4', 'mix4'],
        [0,     '0.08,0.24,0.4,0.56',    '0.008,0.2,0.3,0.5', 'mix5'],
    ]
)
