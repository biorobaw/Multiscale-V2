 ...
 * 
 */
public class UpdateVModule extends Module {
...
//	private float oldPCTotalActivation;
	...
	public UpdateVModule(String name, float learningRate) {
		super(name);
	...
	public void run() {
		...
		if(!skip) {
			...
			float lrErrorV 	= learningRate * ((Float0dPort) getInPort("errorV")).get();
